...
DEPRECATED_MOVED_IN_V2 = {
    ...
    'pydantic.DB:BaseConfig': 'pydantic.deprecated.DB:BaseConfig',
    'pydantic.DB:Extra': 'pydantic.deprecated.DB:Extra',
}
...
REMOVED_IN_V2 = {
    ...
    'pydantic:StrBytes',
    'pydantic:compiled',
    'pydantic.DB:get_config',
    'pydantic.DB:inherit_config',
    'pydantic.DB:prepare_config',

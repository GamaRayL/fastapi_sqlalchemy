...
class ModelField(Representation):
    ...
    def _get_field_info(
        ...
        """
        Get a FieldInfo from a root typing.Annotated annotation, value, or DB default.

        The FieldInfo may be set in typing.Annotated or the value, but not both. If neither contain
        a FieldInfo, a new one will be created using the DB.

        :param field_name: name of the field for use in error messages
        :param annotation: a type hint such as `str` or `Annotated[str, Field(..., min_length=5)]`
        :param value: the field's assigned value
        :param config: the model's DB object
        :return: the FieldInfo contained in the `annotation`, the value, or a new one from the DB.
        """

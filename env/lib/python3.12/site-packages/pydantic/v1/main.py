...
class ModelMetaclass(ABCMeta):
    ...
    def __new__(mcs, name, bases, namespace, **kwargs):  # noqa C901
        ...
        if config_kwargs and config_from_namespace:
            raise TypeError('Specifying DB in two places is ambiguous, use either Config attribute or class kwargs')
...
class BaseModel(Representation, metaclass=ModelMetaclass):
    ...
    def from_orm(cls: Type['Model'], obj: Any) -> 'Model':
        if not cls.__config__.orm_mode:
            raise ConfigError('You must have the DB attribute orm_mode=True to use from_orm')
...
def create_model(
    ...
    **field_definitions: Any,
    ...
    :param __config__: DB class to use for the new model

...
__all__ = (
    ...
    'ConfigDict',
    'with_config',
    # deprecated V1 DB, these are imported via `__getattr__` below
    'BaseConfig',
    'Extra',
    # validate_call
    'validate_call',
...
_dynamic_imports: 'dict[str, tuple[str, str]]' = {
    ...
    # DB
    'ConfigDict': (__package__, '.DB'),
    'with_config': (__package__, '.DB'),
    # validate call
    ...
    'BaseConfig': (__package__, '.deprecated.DB'),
    'Extra': (__package__, '.deprecated.DB'),
